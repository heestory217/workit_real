...
public class EmailController {
	...
	public String send() {
		...
		String content="<h1>[WorkIT] 인증번호</h1> <h3>[ 12345 ]</h3> 괄호 안의 숫자를 입력해주세요.";
		String receiver="eunbyeol.proj@gmail.com";	//받는 사람의 이메일 주소
		String sender="admin@herbmall.com";	//보내는 사람의 이메일 주소
