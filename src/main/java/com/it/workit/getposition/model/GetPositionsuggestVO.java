...
public class GetPositionsuggestVO {
	...
	private int getPositionsuggestImpFlag;	//중요제안여부
	...
	public int getGetPositionsuggestImpFlag() {
		return getPositionsuggestImpFlag;
	}
	public void setGetPositionsuggestImpFlag(int getPositionsuggestImpFlag) {
		this.getPositionsuggestImpFlag = getPositionsuggestImpFlag;
	}
	...
	public String toString() {
		return "GetPositionVO [getPositionNo=" + getPositionNo + ", userNo=" + userNo + ", getPositionsuggestReadFlag="
				+ getPositionsuggestReadFlag + ", getPositionsuggestDelFlag=" + getPositionsuggestDelFlag
				+ ", getPositionsuggestImpFlag=" + getPositionsuggestImpFlag + ", positionsuggestNo="
				+ positionsuggestNo + "]";
	}
}
