...
<%@ include file="../inc/sideMenu.jsp" %>
        ...
        <div style="float: right;">
         	<a href="<c:url value='/admin/siteManage/websiteEdit.do?kind=I&type=N'/>" class="btn btn-secondary" style="margin: 1rem 1rem 0 0;">신규 등록</a>
		    <a href="<c:url value='/admin/siteManage/websiteEdit.do?kind=I&type=E'/>" class="btn btn-primary" style="margin: 1rem 1rem 0 0;">수정하기</a>
        </div>
