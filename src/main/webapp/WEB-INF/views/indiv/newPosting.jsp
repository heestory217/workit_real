...
<div id="new" class="carousel slide" data-ride="carousel"> 
	...
	<a class="carousel-control-prev" href="#new" data-slide="prev" style="margin-bottom: 95px;margin-left: -50px;"> 
		<span class="carousel-control-prev-icon" aria-hidden="true"></span> 
	</a> 
	<a class="carousel-control-next" href="#new" data-slide="next" style="margin-bottom: 95px;margin-right: -50px;"> 
