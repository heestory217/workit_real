	...
	<div id="container">
		...
		<div id="content" class="AllQuestList">
			<div class="header">
				...
				<div class="headerTit">
					<h3>${workkindName}</h3>
					<span>이 직무가 궁금하신가요? 질문을 등록하여 궁금한 점을 해결해보세요!</span>
				</div>
			</div>
			
			<form action="<c:url value='/indiv/community/listByField.do?workkindNo=${param.workkindNo }'/>" 
					name="frmPage" method="post">
				<input type="hidden" name="currentPage">
				<input type="hidden" name="currentPage" value="${param.workkindNo}">
			</form>
			
			<div class="top-title-wrap">
				<p class="title">질문<b> ${totalRecord}</b>건</p>
			</div>
			<!-- 질문 없는 경우 -->
