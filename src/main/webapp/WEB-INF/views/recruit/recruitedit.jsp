            ...
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                    <div class="register-form">
                        <h2>채용공고</h2>
                        <form action="<c:url value='/recruit/recruitedit.do'/>" method="POST">
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" id="recruitannounceSworkkind" name="recruitannounceSworkkind" value="${RecruitannounceVO.recruitannounceSworkkind}">
                            </div>
                            <div class="group-input">
                                <label for="pass">요약-경력(필수)</label>
                                <input type="text" id="recruitannounceScarrer" name="recruitannounceScarrer" value="${RecruitannounceVO.recruitannounceScarrer}">
                            </div>
                            
                            <div class="group-input">
                                <label for="pass">요약-급여(필수)</label>
                                <input type="text" id="recruitannounceSpay" name="recruitannounceSpay" value="${RecruitannounceVO.recruitannounceSpay}">
                            </div>
                            
                            <div class="group-input">
                                <label for="pass">요약-기술(필수)</label>
                                <input type="text" id="recruitannounceSkill" name="recruitannounceSkill" value="${RecruitannounceVO.recruitannounceSkill}">
                            </div>
                            ...
                            <div class="group-input">
		                    	...
		                    	<textarea id="recruitannounceWork" name="recruitannounceWork">${RecruitannounceVO.recruitannounceWork}</textarea><br><br>
								<script type="text/javascript">
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" id="recruitannounceUpcheckcarrer" name="recruitannounceUpcheckcarrer" value="${RecruitannounceVO.recruitannounceUpcheckcarrer}">
                            </div>
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" id="recruitannounceElse" name="recruitannounceElse" value="${RecruitannounceVO.recruitannounceElse}">
                            </div>
                            
                            <div class="group-input">
                                <label for="pass">회사링크</label>
                                <input type="text" id="recruitannounceLink" name="recruitannounceLink" value="${RecruitannounceVO.recruitannounceLink}">
                            </div>
                            ...
                            <button type="submit" class="site-btn register-btn" id='recruitask' name='recruitask'>공고수정 요청</button>
                        </form>
                    </div>
                </div>
            </div>
