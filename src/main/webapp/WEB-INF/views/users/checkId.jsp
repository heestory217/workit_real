...
<body>
	<h2 class="center">아이디 중복 검사</h2><br>
	<form name="frmId" method="post" action="<c:url value='/users/checkId.do'/>">
		 
		<input type="text" name="userid" id="userid" class="inputbtn" title="아이디입력" value="${param.userid}">
		<input type="submit"  id="submit" value="아이디 확인"  class="mybtn">
